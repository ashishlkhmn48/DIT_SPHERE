...
public class PushNotificationActivity extends AppCompatActivity {
    ...
    private void dateTask() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(PushNotificationActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    public void onSend(View view) {
        if (!heading.getText().toString().trim().isEmpty() && !message.getText().toString().trim().isEmpty() && date != null) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(PushNotificationActivity.this);
            ...
            query.getFirstInBackground(new GetCallback<ParseObject>() {
                ...
                public void done(final ParseObject object, ParseException e) {
                    if (e == null) {
                        object.put("heading", heading.getText().toString().trim());
                        object.put("message", message.getText().toString().trim());
                        ...
                        final ParseObject parseObject = new ParseObject("ClubNotification");
                        parseObject.put("heading", heading.getText().toString().trim());
                        parseObject.put("message", message.getText().toString().trim());
                        parseObject.put("date", date);

                        if (img != null) {
                            parseObject.put("image", img);
                        }
            ...
            if (heading.getText().toString().trim().isEmpty()) {
                ...
                heading.setError("Can't Leave Empty");
                heading.requestFocus();

            } else if (date == null) {

                Tooltip.make(PushNotificationActivity.this,
                        new Tooltip.Builder(101)
                                .anchor(layout, Tooltip.Gravity.TOP)
                                .closePolicy(new Tooltip.ClosePolicy()
                                        .insidePolicy(true, false)
                                        .outsidePolicy(true, false), 2000)
                                .activateDelay(800)
                                .showDelay(300)
                                .text("Set the Date First.")
                                .maxWidth(500)
                                .withArrow(true)
                                .withOverlay(true)
                ...
                message.setError("Can't Leave Empty");
