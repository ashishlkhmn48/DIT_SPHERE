...
public class NewsAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MyViewHolder) holder).notification.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    dateTimeTask(heading, ((MyViewHolder) holder).notification);
                } else {
    ...
    private void dateTimeTask(final String heading, final ToggleButton toggleButton) {
    ...
    private void createAlarm(String heading) {
